  ...
  return (
    <section className="relative w-full bg-transparent border-b border-white/20 p-6 lg:p-12 font-mono">
      ...
      <div className="w-full max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6 text-xs text-white/80 uppercase tracking-[0.2em] pt-4 border-t border-[#00E5FF]/30">
          ...
          <div className="flex flex-col gap-2 mt-8 border-l border-white/10 pl-4">
            <div className="flex flex-col">
              <span className="text-white/60 text-[9px]">LOCATION</span>
              <span className="text-white">Hyderabad Telangana India</span>
            </div>
            <div className="flex flex-col">
              <span className="text-white/60 text-[9px]">TIMEZONE</span>
              <span className="text-white">IST (UTC +5:30)</span>
            </div>
            <div className="flex flex-col">
              <span className="text-white/60 text-[9px]">STATUS</span>
              <span className="text-[#00E5FF]">Undergraduate AI & DS</span>
            </div>
            <div className="flex flex-col">
              <span className="text-white/60 text-[9px]">CORE_COMPETENCY</span>
              <span className="text-white">Full-Stack AI Solutions</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-9 flex flex-col gap-12">
          ...
          >
            ...
            <p className="text-sm md:text-base text-white leading-relaxed max-w-4xl mt-4 text-justify font-sans">
          ...
          >
            ...
            <div className="flex flex-col gap-4 text-sm md:text-base text-white font-sans bg-white/[0.02] border border-white/5 backdrop-blur-md rounded-2xl p-8 shadow-[0_0_40px_rgba(0,0,0,0.3)] hover:border-[#00E5FF]/30 transition-all duration-500">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-white/10 pb-6">
                ...
                <span className="text-xs text-white/80 tracking-[0.2em] uppercase mt-2 md:mt-0 font-mono">Sep 2023 - Present</span>
              </div>
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center pt-4">
                ...
                <span className="text-xs text-white/80 tracking-[0.2em] font-mono mt-2 md:mt-0">(OU) Osmania University</span>
              </div>
              <div className="flex flex-col md:flex-row gap-4 mt-2 text-white/90 text-sm font-medium">
