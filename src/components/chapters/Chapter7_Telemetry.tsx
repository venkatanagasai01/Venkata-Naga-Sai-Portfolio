          ...
          >
            ...
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={index} className="flex flex-col bg-white/[0.01] p-8 rounded-3xl border border-white/5 group hover:border-[#D4AF37]/30 transition-all duration-300 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4AF37]/5 blur-[40px] rounded-full pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
