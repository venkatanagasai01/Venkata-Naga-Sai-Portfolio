    ...
    >
      <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4 bg-[#050505]/80 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl relative z-50">
        ...
        <div className="flex items-center gap-2 md:gap-0">
          <a href="#contact" className="hidden md:inline-block px-5 py-2.5 bg-white text-black rounded-full font-sans text-[10px] uppercase tracking-widest hover:bg-[#D4AF37] hover:text-white transition-colors" data-cursor="magnetic">
            Contact
          </a>
